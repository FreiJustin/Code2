...
(function (Solarsystem) {
    ...
    function handleLoad(_event) {
        ...
        const sunPosition = new f.Vector3(0, 0, 0);
        const sunData = new Solarsystem.AstroFudge("Sun", 10, [1, 1, 0, 1], 2, 2, 2, sunPosition, 50);
        const nodeSun = sunData.createNode();
        ...
        f.Loop.start();
        function update() {
            const camZoomSpeed = 50;
            const camRotationSpeed = 5;
